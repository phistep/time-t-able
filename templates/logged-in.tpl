...
<div class="centered main">
	...
	<div class="optionpane">
		...
		<hr />
			<table>
				<tr>
					<td>1.<input type="text" value="<?php echo $timesarray['1']; ?>" /></td>
					<td>7.<input type="text" value="<?php echo $timesarray['7']; ?>" /></td>
				</tr>
				<tr>
					<td>2.<input type="text" value="<?php echo $timesarray['2']; ?>" /></td>
					<td>8.<input type="text" value="<?php echo $timesarray['8']; ?>" /></td>
				</tr>
				<tr>
					<td>3.<input type="text" value="<?php echo $timesarray['3']; ?>" /></td>
					<td>9.<input type="text" value="<?php echo $timesarray['9']; ?>" /></td>
				</tr>
				<tr>
					<td>4.<input type="text" value="<?php echo $timesarray['4']; ?>" /></td>
					<td>10.<input type="text" value="<?php echo $timesarray['10']; ?>" /></td>
				</tr>
				<tr>
					<td>5.<input type="text" value="<?php echo $timesarray['5']; ?>" /></td>
					<td>11.<input type="text" value="<?php echo $timesarray['11']; ?>" /></td>
				</tr>
				<tr>
					<td>6.<input type="text" value="<?php echo $timesarray['6']; ?>" /></td>
					<td>12.<input type="text" value="<?php echo $timesarray['12']; ?>" /></td>
				</tr>
			</table>
		<hr />
	</div>
